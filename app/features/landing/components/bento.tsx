    ...
    >
      <div className="border-x mx-5 md:mx-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 overflow-hidden">
          {/* Real-time AI Collaboration Card */}
          <ChatInteraction />
              ...
              <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
                ...
                <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
                  <div className="relative flex h-full w-full items-center justify-center translate-y-0 md:translate-y-32">
                    <div className="animate-pulse bg-primary/20 w-20 h-20 rounded-lg"></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="w-full h-full flex flex-col relative">
                <div className="absolute inset-0 flex -z-10 [mask:linear-gradient(180deg,transparent,black_40%,black_40%,transparent)]">
                  {Array.from({ length: 8 }).map((_, i) => (
                    <div
                      key={i}
                      className={`w-1/2 h-full ${i % 2 === 1 ? "border-x border-border/70 border-dashed" : ""} flex items-start justify-between`}
                    >
                      {Array.from({ length: 5 }).map((_, j) => (
                        <div
                          key={j}
                          className={`w-px h-5 bg-primary ${j === 0 ? "first:bg-transparent" : ""}`}
                        ></div>
                      ))}
                    </div>
                  ))}
                ...
                <div className="absolute top-10 w-[2px] h-[calc(100%-80px)] bg-gradient-to-b from-black dark:from-accent to-transparent z-10 left-1/2 transform -translate-x-1/2"></div>

                <div className="absolute top-14 bg-black dark:bg-accent h-6 z-20 flex items-center justify-center text-xs p-2 rounded-md shadow-[0px_2.2px_6.6px_0px_rgba(18,43,105,0.04),0px_1.1px_2.2px_0px_rgba(18,43,105,0.08),0px_0px_0px_1.1px_rgba(18,43,105,0.08),0px_1.1px_0px_0px_rgba(255,255,255,0.20)_inset,0px_4.4px_6.6px_0px_rgba(255,255,255,0.01)_inset] left-1/2 transform -translate-x-1/2">
                ...
                <div className="w-full absolute grid gap-10 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/3">
                  <div className="flex items-center h-8 justify-center gap-2 rounded-lg w-[250px] p-2 shadow-[0px_9px_5px_0px_#00000005,0px_4px_4px_0px_#00000009,0px_1px_2px_0px_#00000010] bg-secondary text-white">
                    <p className="font-medium text-sm">Bento grid</p>
                  </div>
                  <div className="flex items-center h-8 justify-center gap-2 rounded-lg w-[250px] p-2 shadow-[0px_9px_5px_0px_#00000005,0px_4px_4px_0px_#00000009,0px_1px_2px_0px_#00000010] bg-secondary/40 text-white transform translate-x-[76px]">
                    <p className="font-medium text-sm">Landing Page</p>
                  </div>
                  <div className="flex items-center h-8 justify-center gap-2 rounded-lg w-[250px] p-2 shadow-[0px_9px_5px_0px_#00000005,0px_4px_4px_0px_#00000009,0px_1px_2px_0px_#00000010] bg-secondary/20 border border-secondary border-dashed text-secondary transform translate-x-[152px]">
    ...
    >
      <div className="relative flex flex-col w-full max-w-xl mx-auto p-4 gap-6 overflow-hidden">
        ...
        {showTypingDots ? (
          ...
          <div
            className="max-w-[300px] p-4 bg-accent border border-border rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.05)]
